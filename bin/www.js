...
import debug from 'debug'                 //importo el modulo para debuguear  NOSEUSAAA
import http from 'http'                   //importo el módulo para crear servidores

//const logger = debug('back-48:server')    //se configura el debugueador
let port = normalizePort(process.env.PORT || '8080')      //defino el puerto donde va a funcionar nuestro servidor front 5173
